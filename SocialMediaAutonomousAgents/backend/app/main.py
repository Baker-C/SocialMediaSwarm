...
from app.api.routes import (
    ...
    pipeline_runs, pipeline_spec, pipeline_templates, auth, agent_builder, engagement,
    provisioning, persona, media, comments,
)
...
app.include_router(pipeline_templates.router, prefix="/api", tags=["pipeline-templates"], dependencies=_auth)
